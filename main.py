...
MODES = {
    "smart": {
        "label": "🧠 Smart Mode",
        "desc": "Intelligent, detailed responses",
        "emoji": "🧠",
    },
    "funny": {
        "label": "😂 Funny Mode",
        "desc": "Humorous, witty responses",
        "emoji": "😂",
    },
    "savage": {
        "label": "🔥 Savage Mode",
        "desc": "Brutally honest responses",
        "emoji": "🔥",
    },
}
...
async def start(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    text = (
        ...
        f"• I'll reply with AI-powered answers!\n\n"
        f"⚙️ *Commands:*\n"
...
async def help_cmd(update: Update, context: ContextTypes.DEFAULT_TYPE):
    text = (
        ...
        "💡 *Tip:* The bot also uses Wikipedia to enhance factual answers!"
    )
    await update.message.reply_text(text, parse_mode="Markdown")
...
async def inline_query(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    try:
        ...
        # Get AI response
        ai_response = await get_ai_response(query, mode, wiki_context=wiki_info)
